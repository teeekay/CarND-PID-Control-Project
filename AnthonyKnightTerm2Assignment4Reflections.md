...
I found that I was able to use manual tuning to determine suitable PID parameters (Kp = 0.244, Ki = 0.0, and Kd = 8.91) that generally worked with the simulator on my computer until the car throttle went above 0.65.  Ki was zero as there was no observable steering bias away from the center of the road.
